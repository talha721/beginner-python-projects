...
def play_game():
    ...
    while not is_game_over:
        ...
        if user_score == 0 or computer_score == 0 or user_score > 21:
            ...
            user_should_deal = input("Type 'y' to get another hand, type 'n' to quit: ")
...
while input("Do you want to play a game of Blackjack? Type 'y' to continue, type 'n' to quit: ") == 'y':
    play_game()